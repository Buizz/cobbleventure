...
RESOURCE_ROOT = PROJECT_ROOT / "content/resources/cobbleventure-world-bootstrap"
...
STARTER_RECEIVED_FLAG = json.loads((PROJECT_ROOT / "content/catalogs/campaign.json").read_text(
    encoding="utf-8"))["values"]["flag_story_starter_received"]
