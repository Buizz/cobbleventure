...
public final class ThemedButton extends AbstractButton {
    ...
    public ThemedButton(
        MenuTheme theme, Component message, int x, int y, int width, int height,
    ...
    public ThemedButton(
        MenuTheme theme, Component message, int x, int y, int width, int height,
        MenuTheme.ButtonVariant variant, Runnable action, BooleanSupplier selected
    ) {
    ...
    protected void renderWidget(GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        ThemedOverlayPanel.fillRoundedRect(
            graphics, getX(), getY(), getX() + getWidth(), getY() + getHeight(), radius, style.border()
        );
        ThemedOverlayPanel.fillRoundedRect(
            graphics, getX() + 1, getY() + 1, getX() + getWidth() - 1, getY() + getHeight() - 1,
